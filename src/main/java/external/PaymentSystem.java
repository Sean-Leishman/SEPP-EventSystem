...
/**
 * Interface for the external PaymentSystem (e.g., PayPal, Transferwise, or similar). It allows requesting for
 * payments to be made from one party to another (both are assumed to be already registered on the payment system), or
 * for payments to be refunded. There is only one PaymentSystem and all users of this application use the same
